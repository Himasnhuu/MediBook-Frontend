...
const NAV_ITEMS = [
  { path: '/patient/search',       label: 'Search Doctors',  short: 'S' },
  { path: '/patient/appointments', label: 'My Appointments', short: 'A' },
  { path: '/patient/records',      label: 'My Records',      short: 'R' },
  { path: '/patient/payments',     label: 'My Payments',     short: 'P' },
];
...
const PatientDashboard = () => {
  ...
  const [patientPhoto] = useState(localStorage.getItem('patientPhoto') || null);
